package com.wowoohr.calculators.family.contribution.common.security;
...
public class Base58 {
        ...
        /**
         * 将给定的byte[]数据编码为Base58的字符串，没有校验和追加内容
         *
         * @param input 需编码的bytes
         * @return 返回编码为Base58的字符串
         */
        public static String encode(byte[] input) {
            ...
            // 转换Base-256的数字为Base-58的数字，后转换为ASCII字符
            input = Arrays.copyOf(input, input.length); // 拷贝一个副本,应为要直接在其上修改
            char[] encoded = new char[input.length * 2]; // char数量上线
        ...
        /**
         * 解码给定的Base58字符串为原始byte[]数据
         *
         * @param input 编码后的base58字符串
         * @return 解码后的byte[]数据
         * @throws Exception 如果给定的字符串不是有效的 base58 字符串
         */
